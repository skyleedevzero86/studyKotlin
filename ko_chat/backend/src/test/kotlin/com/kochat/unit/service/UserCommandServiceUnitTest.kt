package com.kochat.unit.service
...
import com.kochat.support.InMemoryUserPersistencePort
import com.kochat.support.PlainPasswordEncoderPort
    ...
    inner class DeleteTests {
        ...
        fun deleteNotFound() {
            ...
            assertThrows<UserNotFoundException> {
                userCommandService.delete(com.kochat.domain.user.model.DeleteUserCommand("ghost"))
            }
