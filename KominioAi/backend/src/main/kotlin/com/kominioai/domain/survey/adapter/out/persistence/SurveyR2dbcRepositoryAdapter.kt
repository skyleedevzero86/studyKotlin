...
class SurveyR2dbcRepositoryAdapter(
    ...
    override fun saveSurvey(survey: Survey): Mono<SurveyId> {
        ...
        return client.sql(sql)
            ...
            .bind("title", survey.getTitle().value)
            .bind("author", survey.author.name)
            .bind("status", survey.getStatus().name)
            .bind("startDate", survey.getPeriodStartDate())
            .bind("endDate", survey.getPeriodEndDate())
            .bind("participantCount", survey.getParticipationCount())
            ...
            .bind("updatedAt", survey.getUpdatedAt())
            .then()
